...
class SoftgymTshirtLarge : public Scene
{
public:
    float cam_x;
    float cam_y;
	...
	SoftgymTshirtLarge(const char* name) : Scene(name) {}
...
//                cout<<"Spring len:"<<DIST(indMap[a], indMap[b])
    ...
    void Initialize(py::array_t<float> scene_params, int thread_idx=0)
    {
        ...
        if (cloth_type == 0)
            ...
            cloth_prefix = "Tshirt_finer"; // finer mesh, modified by SunHR, 2024.5.2
