...
from softgym.envs.cloth_comp_flatten import ClothCompFlattenEnv
...
from softgym.envs.cloth_comp_tshirt_flatten import ClothCompTshirtFlattenEnv
...
env_arg_dict = {
    ...
    'ClothFlatten': {'observation_mode': 'cam_rgb',
                     ...
                     'use_cached_states': True,
                     'deterministic': False},
    'ClothCompFlatten': {'observation_mode': 'cam_rgb',
                         'action_mode': 'picker',
                         'num_picker': 2,
                         'render': True,
                         'headless': True,
    ...
    'TshirtFlatten': {'observation_mode': 'cam_rgb',
                      ...
                      'use_cached_states': True,
                      'deterministic': False},
    'ClothCompTshirtFlatten': {'observation_mode': 'cam_rgb',
                      'action_mode': 'picker',
                      'num_picker': 2,
                      'render': True,
                      'headless': True,
...
SOFTGYM_ENVS = OrderedDict({
    ...
    'ClothCompFlatten': ClothCompFlattenEnv,
    ...
    'ClothCompTshirtFlatten': ClothCompTshirtFlattenEnv
})
